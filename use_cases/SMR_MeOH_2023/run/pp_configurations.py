...
dic_var_names = {'htse_capacity':'HTSE', 'meoh_capacity':'FT', 'h2_storage_capacity':r'$H_2\; storage$'}
...
def plot_configurations(df_list): 
  ...
  for row, subfig in enumerate(subfigs):
    ...
    df['h2_storage_capacity'] = np.round(df['h2_storage_capacity']/1e3)
  ...
  fig.savefig(os.path.join(os.path.dirname(os.path.abspath(__file__)), "smr_meoh_SA_results_configurations.png"))
