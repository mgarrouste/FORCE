...
dic_var_units = {'htse_capacity':'MWe', 'ft_capacity':r'$ton-H_2/h$', 'h2_storage_capacity':r'$ton-H_2$'}
dic_var_names = {'htse_capacity':'HTSE', 'ft_capacity':'FT', 'h2_storage_capacity':r'$H_2\; storage$'}
...
def plot_configurations(df_list): 
  ...
  fig.savefig(os.path.join(os.path.dirname(os.path.abspath(__file__)), "smr_ft_SA_results_configurations.png"))
